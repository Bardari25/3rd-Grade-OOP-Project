...
if __name__ == "__main__":
    ...
    bardari=Label(urunarama, text="Burak Arda Ari", bg='#add8e6', font="Verdana 15 bold")
    bardari.place(relx=0.5, rely=0.69, relheight=0.04, relwidth=0.37)

    selin=Label(urunarama, text="Selin Polat", bg='#add8e6', font="Verdana 15 bold")
    selin.place(relx=0.5, rely=0.73, relheight=0.04, relwidth=0.37)

    ibo=Label(urunarama, text="İbrahim Aydoğdu", bg='#add8e6', font="Verdana 15 bold")
    ibo.place(relx=0.5, rely=0.77, relheight=0.04, relwidth=0.37)
